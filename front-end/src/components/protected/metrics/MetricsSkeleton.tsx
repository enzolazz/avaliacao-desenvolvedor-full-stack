      ...
      <div className="space-y-6">
        <Skeleton className="w-full bg-sidebar flex flex-col p-8 justify-between">
          <div className="w-full flex justify-between items-center gap-4">
            <Skeleton className="w-30 h-6 bg-muted-foreground/20" />
            <Skeleton className="w-42 h-8 bg-muted-foreground/20" />
          </div>
          <Separator className="my-8" />
          <div className="flex flex-col gap-6">
            <div className="w-full flex justify-between items-center gap-4">
              <Skeleton className="w-30 h-4 bg-muted-foreground/20" />
              <Skeleton className="w-42 h-4 bg-muted-foreground/20" />
            </div>
            <div className="w-full flex justify-between items-center gap-4">
